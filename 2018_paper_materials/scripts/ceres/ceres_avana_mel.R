...
avana_rep_map <- file.path(".", "Avana_replicatemap_melanoma.tsv")

### Run CERES on Avana data

inputs_dir <- file.path("./avana_ceres_inputs_mel", Sys.Date())
...
write.csv(avana_ceres_scaled, file="avana_ceres_mel.csv")
