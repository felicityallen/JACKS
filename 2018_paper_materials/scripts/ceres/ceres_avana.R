...
avana_dep_file <- file.path(data_dir,"Avana_sgrnareplicateslogfcnorm.gct")
avana_rep_map <- file.path(data_dir, "Avana_replicatemap.tsv")


### Run CERES on Avana data

inputs_dir <- file.path(paste("./avana_ceres_inputs"), Sys.Date())
...
write.csv(avana_ceres_scaled, file="avana_ceres.csv")
