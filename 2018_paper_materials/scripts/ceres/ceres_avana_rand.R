...
avana_dep_file <- file.path("../../data","Avana_sgrna_raw_readcounts_rand_matched_lfnorm.gct")
avana_rep_map <- file.path(".", "Avana_replicatemap_rand.tsv")


### Run CERES on Avana data

inputs_dir <- file.path("./avana_ceres_inputs_rand", Sys.Date())
...
write.csv(avana_ceres_scaled, file="avana_ceres_rand.csv")
